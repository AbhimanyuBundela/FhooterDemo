...
#include "Fhooter/Character/FhooterAnimInstance.h"
#include "Fhooter/Weapon/Projectile.h"
#include "Fhooter/Weapon/Shotgun.h"
...
void UCombatComponent::UpdateCarriedAmmo()
{
	...
	Controller = Controller == nullptr ? Cast<AFhooterPlayerController>(Character->Controller) : Controller;
	if (Controller)
	{
...
void UCombatComponent::SetHUDCrosshairs(float DeltaTime)
{
	...
	if (Controller)
	{
		HUD = HUD == nullptr ? Cast<AFhooterHUD>(Controller->GetHUD()) : HUD;
		if (HUD)
		{
			if (EquippedWeapon)
			{
